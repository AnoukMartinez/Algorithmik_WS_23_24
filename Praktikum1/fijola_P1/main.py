...
def avl_suggest(filename: str, csv_no: str):
    ...
    if csv_no == 'csv01':
        ...
        print("my_avl_suggest get_k_possible_suggestions_alphabetical_asc: ", my_avl_suggest.get_k_possible_suggestions_alphabetical_asc("ei", 3))
        print("=================get_k_possible_suggestions_alphabetical_desc=========================")
        print("my_avl_suggest get_k_possible_suggestions_alphabetical_desc: ", my_avl_suggest.get_k_possible_suggestions_alphabetical_desc("ei", 3))
        print("==========================================")
